                    ...
                    <?php
                        ...
                        if (mysqli_num_rows($resultado) > 0) {
                            ...
                            while ($row = mysqli_fetch_assoc($resultado)) {
                                ...
                                echo "<td>
                                 <form action='Feedbacksaceitos.php' method='POST' style='display:inline;'>
                <input type='hidden' name='id_professor' value='" . $row["id_professor"] . "'>
                <input type='hidden' name='nome_professor' value='" . $row["nome_professor"] . "'>
                <input type='hidden' name='feedback' value='" . $row["feedback"] . "'>
                  <input type='hidden' name='id_feedback' value='" . $row["id_feedback"] . "'>
                <button class='bg-green-500 text-white px-4 py-2 rounded-lg hover:bg-green-700'>Aceitar</button>
                 
            </form>
               
                                        <form action='ExcluirFeedback.php' method='POST' style='display:inline;'>
                                            <input type='hidden' name='id_feedback' value='" . $row["id_feedback"] . "'>
                                            <button type='submit' class='bg-red-500 text-white px-4 py-2 rounded-lg hover:bg-red-700 '>Excluir</button>
                                        </form>
