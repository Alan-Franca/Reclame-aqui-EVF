...
function validarFeedbackAluno() {
    ...
    <header class="flex justify-between items-center p-4 bg-black">
        <div class="text-3xl font-bold">Portal do Professor</div>
    ...
    <div class="flex justify-center items-center" style="height: 100vh;">
        <div class="bg-white text-black p-6 rounded-lg w-80">
            ...
            <form name="feedbackAluno" method="POST" action="enviarFeedbackProfessor.php" onsubmit="return validarFeedbackAluno()">
                <div class="text-left mb-4">
                    <!-- Campo Nome -->
                    <h2 class="text-xl font-bold mb-4">ID DA SALA</h2>
                    <input class="input mb-4 w-full p-2 border border-gray-300 rounded-md" type="text" name="id_sala" placeholder="Digite aqui">
                </div>
